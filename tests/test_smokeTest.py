...
class TestSmokeTest():
    ...
    def test_4JoinPageInputVerificatoin(self):
        ...
        elements = self.driver.find_elements(
            By.CSS_SELECTOR, ".myinput:nth-child(2)")
        assert len(elements) > 0
        ...
        self.driver.find_element(
            By.NAME, "bizname").send_keys("YouBusinessName")
        self.driver.find_element(By.NAME, "biztitle").send_keys(
            "YourTitleOrPosition")
    ...
    def test_5AdminPageLoginErrorVerification(self):
        ...
        assert len(elements) > 0
        self.driver.find_element(
            By.ID, "username").send_keys("incorrectUserName")
        self.driver.find_element(
            By.ID, "password").send_keys("incorrectPassword")
        self.driver.find_element(
